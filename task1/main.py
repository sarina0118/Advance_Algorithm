...
print("HASH TABLE")
table = HashTable()
table.insert(City("Kathmandu", 85.32, 27.71, 845767, 12.5))
table.insert(City("Pokhara", 83.99, 28.20, 402995, 30.1))
table.insert(City("Butwal", 83.45, 27.70, 195054, 18.2))
table.insert(City("Biratnagar", 87.27, 26.45, 244750, 22.3))
table.insert(City("Dharan", 87.28, 26.81, 153875, 16.8))
print("\nCities in Hash Table:\n")
table.display()
print("\nSearching for Pokhara...\n")
result = table.search("Pokhara")
if result:
    print(result)
else:
    print("City not found.")

print("\nTotal Cities:", table.count())
print("\nDeleting Butwal from hash table list\n")

if table.delete("Butwal"):
    print("Butwal deleted successfully.")
else:
    print("City not found.")
